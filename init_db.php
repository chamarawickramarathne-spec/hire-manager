...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS plan_subscriptions (
        ...
        status ENUM('active', 'expired', 'cancelled', 'Completed', 'Failed') DEFAULT 'active',
        notes TEXT,
    ...
    try {
        $db->exec("ALTER TABLE plan_subscriptions MODIFY COLUMN status ENUM('active', 'expired', 'cancelled', 'Completed', 'Failed') DEFAULT 'active'");
        echo "plan_subscriptions status column updated.\n";
    } catch (Throwable $e) {}
